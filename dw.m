...
saveas(gcf,'figurer til bachelor/dwc_1.png');
...
grid();
set(gcf,'PaperUnits','centimeters','PaperPosition',[0 0 a*r a])
saveas(gcf,'figurer til bachelor/dwc_2.png');
...
figure(2)
patch([n,fliplr(n)],[ones(1,130)*1.2,ones(1,130)*1.4],[0.9 0.9 0.9])
hold on
...
plot([d.Lambda(d.burning == 1),d.Water_temperature__C_(d.burning == 1)/90,d.RPM(d.burning == 1)/4000])
