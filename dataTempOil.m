...
hold off
title('Lambda gear 1')
legend('Desired lambda','Sweep 1','Sweep 2','Sweep 4','Sweep 6','Sweep 8','Sweep 10','Location','best')
set(gca,'FontSize',15)
ylim([0.70 1.6])
xlim([1500 4000])
xlabel('RPM')
...
legend('Sweep 1','Sweep 2','Sweep 4','Sweep 6','Sweep 8','Sweep 10','Location','best')
set(gca,'FontSize',15)
ylim([5000 6000])
xlim([1500 4000])
xlabel('RPM')
